...
import useHandleUpdateRowSubmit from "./useHandleUpdateRowSubmit";

const UpdateRowFormLowerPart = ({ setShowUpdateRow, currentRowData }) => {
    const { handleUpdateRowSubmit, fields, setFields, tableColumnData } =
        useHandleUpdateRowSubmit(setShowUpdateRow, currentRowData);
...
export default UpdateRowFormLowerPart;
